...
\endhead
Peak EE (close-out exposure) & \$10.4M at 2026-09-20 & Highest average 10-day close-out exposure within one year \\
\rowcolor{gray!9}Peak median PFE (close-out) & \$7.0M & Typical (50th percentile) close-out exposure at its highest date \\
Maximum PFE99, MPE (close-out) & \$45.7M at 2026-09-04 & Highest 99th-percentile close-out exposure within one year \\
\rowcolor{gray!9}Current exposure today (uncollateralized) & \$107.7M & Loss if every counterparty defaulted today with no margin, after netting \\
MPE99, uncollateralized (secondary view) & \$174.7M at 2026-10-09 & Highest 99th-percentile level exposure over the life of the book \\
\rowcolor{gray!9}Concentration & 99\% of current exposure is CPTY\_C & A single \$500M bond forward (BF\_0003) dominates \\
Time profile & Most exposure has run off by December 2026 & Trades mature; a small Bond TRS tail runs to January 2028 \\
\rowcolor{gray!9}Greeks & t = 0 book Greeks; sensitivities of EE, median PFE and PFE99 to equities, USDJPY, USD rates and volatilities & Complete, by netting set (Section 9) \\
...
\end{verbatim}}
Each step is the exact log-normal step ln S(t+dt) = ln S(t) + (r - q - sigma\textasciicircum{}2/2) dt + sigma sqrt(dt) Z, with r the simulated USD short rate at the start of the step (so equities and rates are linked). Under the risk-neutral measure the expected growth is r - q, verified in Section 11 by a martingale test.
...
\end{figure}
\textbf{Trade-off.} The factor model is smoother and more robust to estimation noise and gives quasi-random sequences a low-dimensional space where they work best, but it only approximates the empirical matrix. Because it changes results, it is an option (corr\_mode=`factor'), not the default. Section 7.6 compares its exposure profiles with the full-rank engine.
...
\endhead
CPTY\_A & \$4.7M & \$0.5M & \$25.2M & 2026-09-20 \\
\rowcolor{gray!9}CPTY\_B & \$1.8M & \$0.4M & \$9.8M & 2026-09-20 \\
CPTY\_C & \$3.9M & \$0.6M & \$22.1M & 2026-09-04 \\
\rowcolor{gray!9}Portfolio & \$10.4M & \$7.0M & \$45.7M & 2026-09-04 \\
\bottomrule
\end{longtable}}
...
\endhead
EQTRS\_0001 & CPTY\_A & -8,377,700 & 1,884,623 & 10,179,418 \\
\rowcolor{gray!9}EQTRS\_0002 & CPTY\_A & -2,079,657 & 1,936,254 & 10,755,759 \\
EQTRS\_0003 & CPTY\_A & 11,151,337 & 2,159,408 & 11,952,682 \\
\rowcolor{gray!9}EQTRS\_0004 & CPTY\_B & -1,051,939 & 837,334 & 4,626,625 \\
EQTRS\_0005 & CPTY\_B & 51,772 & 278,068 & 1,441,254 \\
\rowcolor{gray!9}EQTRS\_0006 & CPTY\_B & 1,393,250 & 1,357,824 & 7,274,715 \\
EQTRS\_0007 & CPTY\_C & 826,403 & 2,013,796 & 11,370,928 \\
\rowcolor{gray!9}EQTRS\_0008 & CPTY\_C & 1,947,022 & 600,882 & 3,183,304 \\
BF\_0001 & CPTY\_A & 512,531 & 101,496 & 570,541 \\
\rowcolor{gray!9}BF\_0002 & CPTY\_A & -432,501 & 78,493 & 461,684 \\
BF\_0003 & CPTY\_C & 101,417,649 & 3,233,786 & 18,394,722 \\
\rowcolor{gray!9}BF\_0004 & CPTY\_C & 1,973,388 & 43,922 & 237,221 \\
BTRS\_0001 & CPTY\_A & 123,516 & 1,729 & 6,720 \\
\rowcolor{gray!9}BTRS\_0002 & CPTY\_B & 221,019 & 66,954 & 109,235 \\
BTRS\_0003 & CPTY\_B & 28,948 & 11,401 & 19,744 \\
\rowcolor{gray!9}BTRS\_0004 & CPTY\_C & 37,741 & 23,531 & 28,954 \\
\bottomrule
\end{longtable}}
...
\item Exposure Greeks are computed at N = 2,000 scenarios (Latin Hypercube), for the uncollateralized book, on the pillar date grid.
\end{itemize}
...
\endhead
CPTY\_A & 897,526 & -2,280,302 & 0 & 0 & 31,258 & -16 \\
\rowcolor{gray!9}CPTY\_B & 586,826 & -966,846 & 0 & 420,465 & -3,752 & 6 \\
CPTY\_C & 106,202,202 & -1,231,141 & 0 & 0 & 637,630 & -1,300 \\
\rowcolor{gray!9}Portfolio & 107,686,554 & -4,478,289 & 0 & 420,465 & 665,137 & -1,310 \\
\bottomrule
\end{longtable}}
...
\endhead
CPTY\_A & -565 & 83 & 3,715 & 13,865 & 399 & 9,692 & 4,069 & 0 \\
\rowcolor{gray!9}CPTY\_B & -2,649 & -905 & -72 & -1 & -1 & -86 & -38 & 0 \\
CPTY\_C & -3,776 & -102 & 4,667 & 6,291 & 6,240 & 433,804 & 190,506 & 0 \\
\bottomrule
\end{longtable}}
...
These are the Greeks that matter for counterparty credit risk: how EE, median PFE and PFE99 change when a market factor moves. The figure shows the portfolio profiles for the three main factors, and the table gives the sensitivities at the date of peak PFE99 (2026-10-09), by netting set.
...
\endhead
All equities +1\% & EE & -1,095,935 & -539,348 & -1,233,470 & -2,868,753 \\
\rowcolor{gray!9} & Median PFE & -1,363,675 & -964,461 & -1,244,428 & -2,759,673 \\
 & PFE99 & -1,894,675 & -829,702 & -1,044,390 & -3,907,784 \\
\rowcolor{gray!9}USDJPY +1\% & EE & 0 & 226,832 & 0 & 226,832 \\
 & Median PFE & 0 & 412,132 & 0 & 192,426 \\
\rowcolor{gray!9} & PFE99 & 0 & 314,078 & 0 & 345,892 \\
USD rates +1bp & EE & 14,839 & -1,951 & 635,801 & 648,689 \\
\rowcolor{gray!9} & Median PFE & 29,137 & -3,393 & 627,855 & 624,517 \\
 & PFE99 & 28,938 & -3,311 & 610,815 & 637,953 \\
\rowcolor{gray!9}Rate volatility +1\% & EE & 157 & 18 & -119 & 55 \\
 & Median PFE & -3,667 & 176 & 1,745 & 26,048 \\
\rowcolor{gray!9} & PFE99 & 8,845 & 744 & 126,540 & 125,471 \\
FX volatility +1\% & EE & 0 & 0 & 0 & 0 \\
\rowcolor{gray!9} & Median PFE & 0 & 0 & 0 & 0 \\
 & PFE99 & 0 & 0 & 0 & 0 \\
\rowcolor{gray!9}Equity volatility +1\% & EE & 73,227 & 25,802 & -541 & 98,487 \\
 & Median PFE & 23,427 & 5,040 & -27,261 & 40,892 \\
\rowcolor{gray!9} & PFE99 & 362,225 & 118,917 & 171,905 & 535,707 \\
All-equity gamma (+1\%) & EE & 119,200 & 55,173 & 0 & 174,373 \\
\rowcolor{gray!9} & PFE99 & -0 & -0 & 0 & -0 \\
USDJPY gamma (+1\%) & EE & 0 & 6,154 & 0 & 6,154 \\
\rowcolor{gray!9} & PFE99 & 0 & -6,399 & 0 & -6,918 \\
Rate gamma (+1bp) & EE & 21 & 5 & -1,276 & -1,250 \\
\rowcolor{gray!9} & PFE99 & -14 & 5 & -1,223 & -1,236 \\
\bottomrule
\end{longtable}}

{\small Change in the measure, in USD, at 2026-10-09. Delta and vega are one-sided shifts read as change per unit shift; gamma is the second difference.}

\textbf{Reading the table.} The equity delta of exposure is negative (EE falls by about \$2,869k per +1\% on all equities and PFE99 by \$3,908k): the swaps are pay-equity, so our claim on the counterparty shrinks when shares rise, and the adverse scenarios for credit exposure are equity falls. The USD rate DV01 of PFE99 is positive (\$638k per +1bp), reflecting the funding legs and bond forwards. The equity and rate gammas of the exposure are positive, as expected for max(V, 0) (a call on the netted value), and small relative to the deltas at a +1\% shift.
...
\endhead
t = 0 book Greeks & 2.2 s & Central differences on the pricers: every trade, 37 equities, FX, DV01 parallel and 8 buckets \\
\rowcolor{gray!9}Base run (paths and full repricing) & 115 s & 16 trades, all dates, 8 worker processes (includes process start-up) \\
78 equity and FX bumps & 110 s & No re-simulation; only the trades holding the factor are repriced; one process pool. Re-simulating each would cost about 10,317 s (94x more) \\
\rowcolor{gray!9}One rate or volatility re-simulation & 132 s & 12 are needed: parallel up and down, 8 buckets, three vega bumps \\
\bottomrule
\end{longtable}}

Timings were measured separately at N = 300 because the wall-clock of the N = 2,000 production run was distorted by the machine sleeping during the overnight job; costs scale about linearly with N once process start-up is amortised.
...
\endhead
t = 0 equity delta against the analytic value (shares x spot x 1\%, signed by trade direction), all 41 trade-name pairs & maximum relative error 1.5e-03 \\
\rowcolor{gray!9}Bump-size stability of the all-equity EE delta at the peak date: 0.5\%, 1\%, 2\% bumps (USD k per +1\%) & -2,870, -2,869, -2,869 (spread 0.03\%) \\
Additivity: sum of the 37 single-name EE deltas against the all-equity delta (maximum over all dates after t = 0) & 1.34\% of the peak all-equity delta \\
\rowcolor{gray!9}The same at t = 0 itself & 25\%: at t = 0 the exposure max(V, 0) is deterministic and has a kink, and a 1\% bump of one name can cross it (CPTY\_A, CPTY\_B), so single-name and joint finite differences need not add there \\
Sum of single-name PFE99 deltas against the all-equity PFE99 delta at the peak date (quantiles are not additive) & -3,908 against -3,908 USD k \\
\rowcolor{gray!9}Common random numbers against independent draws: standard deviation of the EE delta estimate over 4 repeats at N = 300 & 33 USD k against 472 USD k (14x lower) \\
\bottomrule
\end{longtable}}
...
\item Quantile Greeks (PFE99) carry more estimation noise than EE even with common random numbers; the reported figures use 2,000 scenarios.
\item Interest rate Greeks are for the USD curve only: the JPY rate is not simulated, so JPY rate risk enters through the USD curve. There is no inflation, credit-spread or dividend Greek for exposure (credit-spread and vega sensitivities of CVA are in Section 8).
...
\item Exposure Greeks are for the uncollateralized book at 99\%; a collateralized book would have different (much smaller) sensitivities.
\end{itemize}
\clearpage
...
\begin{itemize}
\item \textbf{Exposure definition and USD curve.} The headline exposure is uncollateralized rather than the brief's 10-day movement from the prior-day NPV, and the USD curve is flat beyond about seven years (Section 15.2); both are scheduled for correction in Section 15.3.
\item \textbf{Uncollateralized and no CSA data.} If margin exists, results change by up to an order of magnitude (Section 7.5).
...
\begin{itemize}
\item The engine is validated (t=0 self-check, martingale, VaR benchmark, stress test, 82 tests) and reproducible with a single command per stage.
\item On the exposure definition in the brief (10-day close-out from the prior-day value), the portfolio MPE99 is \$45.7M at 2026-09-04, with peak EE of \$10.4M and peak median PFE of \$7.0M (Section 7.1).
\item The uncollateralized level exposure, kept as a secondary view, has peak portfolio PFE99 of \$174.7M at 2026-10-09, versus EE of \$121.9M and median PFE of \$121.3M; the spread between these three is the point of reporting all of them.
...
\item Greeks are complete for the book and for the exposure measures (Section 9): PFE99 at its peak date falls by about \$3,908k per +1\% on all equities and rises by about \$638k per +1bp on USD rates.
...
\item Next engineering steps: wire the JPY Hull-White factor into JPY equity/FX drift; a two-factor or regime-aware rate model if a long JPY curve history becomes available; a vectorised pricer reimplementation if scenario counts must exceed $\sim$10,000; a model-risk study varying a, vols and correlation.
\end{itemize}
\clearpage
\section{Improvement plan for the next week}
A review of this work against the requirements in the kickoff deck (project objectives on slide 5, exposure definition and key assumptions on slides 8 and 9, deliverables and extra credit on slide 10), and against an independent implementation of the same brief, identified the gaps below. Items in Priority 1 are needed for the deliverable to meet the brief in full; Priority 2 items complete the extra-credit and validation scope. Item 1 is done (Section 7.1); the CVA, SA-CVA and Greeks results in Sections 8 and 9 should be read with the remaining known issues in mind until Priority 1 is complete.

\subsection{Requirements traceability}
{\scriptsize\setlength{\LTpre}{4pt}\setlength{\LTpost}{6pt}
\begin{longtable}{>{\raggedright\arraybackslash}p{\dimexpr 0.4865\linewidth-2\tabcolsep\relax}>{\raggedright\arraybackslash}p{\dimexpr 0.3784\linewidth-2\tabcolsep\relax}>{\raggedright\arraybackslash}p{\dimexpr 0.1351\linewidth-2\tabcolsep\relax}}
\toprule
\rowcolor{navy}\textbf{\textcolor{white}{Kickoff requirement}} & \textbf{\textcolor{white}{Status}} & \textbf{\textcolor{white}{Action}} \\
\endhead
Stochastic models for rates, equity and FX, defended & Done & - \\
\rowcolor{gray!9}Correlated joint simulation; correlation from history & Done & - \\
Provided pricers called on simulated market states & Done & - \\
\rowcolor{gray!9}Exposure = movement from the prior-day NPV over a 10-day close-out; no initial margin; variation margin equals the prior-day NPV (slide 9) & Done (Section 7.1): three-node grid, signed prior-day variation margin, netting before the positive part, settlement excluded & Item 1 done \\
...
\rowcolor{gray!9}Exposures per trade and aggregated to the counterparty (slide 8) & Done (Section 7.1): 16 trades and 3 counterparties & Item 1 done \\
Netting-set exposure profiles & Done & - \\
\rowcolor{gray!9}Evidence of convergence in the number of simulations (slide 9) & Done (Section 5.5) & - \\
...
\rowcolor{gray!9}Speed and performance benchmarks; analytical accuracy benchmarks & Done (Sections 5 and 11) & - \\
...
\rowcolor{gray!9}Repository, technical report, presentation to the Risk department & Done; presentation to be refreshed & Item 8 \\
Extra credit: xVA outputs & Partial: CVA and SA-CVA capital; no DVA or FVA & Item 5 \\
\rowcolor{gray!9}Extra credit: risky bonds and CDS data for new sample trades & Not done & Item 9 \\
\bottomrule
\end{longtable}}

\subsection{Known issues in the current results}
\begin{itemize}
\item \textbf{Exposure definition (resolved for the exposure measures).} The headline exposure now follows the brief (Section 7.1). CVA, SA-CVA and the Greeks in Sections 8 and 9 were computed earlier on the uncollateralized level exposure and are scheduled to be re-run on the close-out definition (item 4); until then they are conservative for a margined counterparty and, for CVA, are not yet on the brief's definition.
\item \textbf{USD curve beyond seven years.} The SOFR-futures curve covers about 6.3 years and is extrapolated flat, so the 2049 Treasury underlying BF\_0003 is discounted at 4.27\% instead of about 4.64\% at 20 years. Repricing with Bloomberg's zero curve gives an NPV of \$120.9M for BF\_0003 against \$101.4M on our curve, about 16 percent higher. CPTY\_C exposure, CVA and SA-CVA are therefore understated.
\item \textbf{JPY rate not simulated.} The JPY Hull-White factor is built and calibrated but JPY equity and USDJPY drift still use a constant differential (Section 4.5).
\end{itemize}
\subsection{Work plan}
\textbf{Priority 1: needed to meet the brief in full}

{\scriptsize\setlength{\LTpre}{4pt}\setlength{\LTpost}{6pt}
\begin{longtable}{>{\raggedright\arraybackslash}p{\dimexpr 0.0667\linewidth-2\tabcolsep\relax}>{\raggedright\arraybackslash}p{\dimexpr 0.4800\linewidth-2\tabcolsep\relax}>{\raggedright\arraybackslash}p{\dimexpr 0.4533\linewidth-2\tabcolsep\relax}}
\toprule
\rowcolor{navy}\textbf{\textcolor{white}{Item}} & \textbf{\textcolor{white}{Work}} & \textbf{\textcolor{white}{Deliverable and check}} \\
\endhead
...
\rowcolor{gray!9}2 & Replace the flat long end of the USD curve with the Bloomberg zero curve (or splice it beyond the last futures contract) & Curve validated against Treasury and against the Bloomberg curve; BF\_0003 NPV reconciled; all trades repriced \\
...
\rowcolor{gray!9}4 & Re-run everything on the corrected engine: exposure profiles, MPOR view, CVA, SA-CVA, Greeks, convergence at the recommended path count & Refreshed data files; regression tests; comparison before and after \\
\bottomrule
\end{longtable}}

\textbf{Priority 2: completes extra credit and validation}
...
\rowcolor{gray!9}6 & Backtest simulated PFE against realised outcomes with a Kupiec proportion-of-failures test, at 95 and 99 percent, on the equity names and where possible the book & Backtest module with truncation of history at each as-of date (no look-ahead); pass or fail statement \\
...
\rowcolor{gray!9}8 & Refresh the report and executive deck for the Risk department presentation; rehearse & Updated PDF, LaTeX source and deck; slide on the changes and their effect on results \\
...
\subsection{Further model refinements (after the above)}
\begin{itemize}
\item Two-factor rate model and stochastic volatility, if Capitolis wants richer dynamics; the vol-of-vol correlation must be applied in the paths if it is fit.
\item Brownian-bridge interpolation with conditional variance where exposure is read at off-grid dates.
\item Model-risk study varying mean reversion, volatilities and correlation.
\item Collateral terms (threshold, minimum transfer amount, initial margin) once Capitolis provides the credit support annexes, and wrong-way risk in CVA.
\item Real counterparty ratings and credit curves to replace the BBB assumption.
\end{itemize}
\clearpage
\clearpage
\appendix
...
\rowcolor{gray!9}Greeks & Bump-and-reprice with common random numbers; equity and FX bumps reuse paths (exact GBM rescaling, subset repricing); rate and vol bumps re-simulate & +1\% spot, +1bp rates (parallel and 8 buckets), +1\% vol; N = 2,000 & greeks/book.py, greeks/exposure.py, scripts/run\_greeks.py \\
Precision & Bootstrap resampling of a large pool; 1/sqrt(N) extrapolation & Relative SE of PFE99 about 1.0\% at N = 5,000 at the worst date & scripts/convergence\_study\_tail.py \\
\rowcolor{gray!9}Validation & t=0 self-check, martingale test, delta-normal VaR, stress test, unit tests & 82 automated tests & scripts/, tests/ \\
\bottomrule
\end{longtable}}
...
\rowcolor{gray!9}greeks/ & book (t=0 Greeks by trade and netting set), exposure (sensitivities of EE, median PFE, PFE99), bumps (curve and parameter bump helpers) \\
exposure/ & aggregate (netting, EE, median PFE, PFE, MPE), collateral (MPOR-shifted), cva (regulatory CVA), sa\_cva (Basel aggregation) \\
\rowcolor{gray!9}scripts/ & run\_simulation, run\_mpor\_comparison, run\_sa\_cva, generate\_report\_data, build\_report (LaTeX), build\_exec\_deck, and the convergence, variance-reduction, VaR, martingale and stress benchmarks \\
